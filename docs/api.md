...
| COMMON_429 | 429  | PIN 인증 시도 횟수 초과 (IP별 분당 5회 제한) |
...
**에러**: AUTH_001(PIN 불일치), GROUP_001, COMMON_400(형식 위반), COMMON_429(시도 횟수 초과)
...
**에러**: GROUP_001, MEMBER_000(다른 그룹 소속이거나 존재하지 않는 멤버)
